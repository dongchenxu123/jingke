            ...
            <div className="panel-body">
                <div className="col-md-4" style={{borderRight: '1px solid #dedede'}}>
                    ...
                    <p style={{paddingBottom: '20px', textAlign: 'center'}}>
                        <span style={{fontSize: '32px', color: '#f3a01c'}}>{FormateNum(waiting_cnt)}</span>
                ...
                <div className="col-md-4" style={{borderRight: '1px solid #dedede'}}>
                    ...
                    <p style={{paddingBottom: '20px', textAlign: 'center'}}>
                        <span style={{fontSize: '32px', color: '#f3a01c'}}>{FormateNum(curr_week_cnt)}</span>
                ...
                <div className="col-md-4">
                    ...
                    <p style={{paddingBottom: '20px', textAlign: 'center'}}>
                        <span style={{fontSize: '32px', color: '#f3a01c'}}>{FormateNum(curr_month_cnt)}</span>
                        <span style={{fontSize: '30px'}}>个计划</span>
                    </p>
                </div>
            </div>
